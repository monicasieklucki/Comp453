...
from OnlineFoodOrdering import db
from OnlineFoodOrdering.models import User
...
class RegistrationForm(FlaskForm):
    username = StringField('Username', validators=[DataRequired(), Length(min=2, max=20), Regexp('^[a-zA-Z]+$', message="Name can only accept charater"),])
